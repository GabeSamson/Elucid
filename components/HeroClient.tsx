      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 text-center">
        ...
        >
          <img
            ...
            className="w-[90vw] max-w-[420px] sm:w-64 sm:max-w-none md:w-80 lg:w-[520px] xl:w-[640px] drop-shadow-2xl invert brightness-0 contrast-200 select-none pointer-events-none transform -translate-x-[10px] rounded-2xl"
          />
        </motion.div>
